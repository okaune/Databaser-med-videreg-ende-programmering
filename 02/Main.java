...
class GodkjenningBGS {
  ...
  public GodkjenningBGS(TaskOverview2 oversikt) {
    ...
    private void registrerOppgaver(String studNavn) {
      ...
      do { // gjentar inntil registrering aksepteres av objektet oversikt
        try {
          ...
          oversikt.increaseNumTasks(studNavn, antOppgØkning);  // kan ikke returnere false, pga navn alltid gyldig
      ...
      melding = "Totalt antall oppgaver registrert på " + studNavn + " er " + oversikt.getNumTasks(studNavn) + ".";
